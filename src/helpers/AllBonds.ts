...
export const hiro_bnb = new LPBond({
  name: "HIRO-BNB",
  displayName: "HIRO-BNB LP",
  bondToken: "PID-BUSD",
  bondIconSvg: "null",
  bondContractABI: BondOhmDaiContract,
  reserveContract: ReserveOhmDaiContract,
  ...
  lpUrl:
   `https://pancakeswap.finance/add/${addresses[NetworkID.Mainnet].DAI_ADDRESS}/${addresses[NetworkID.Mainnet].HIRO_ADDRESS}`,
});


export const ohm_dai = new LPBond({
  name: "HIRO-DAI",
  displayName: "HIRO-DAI LP",
  bondToken: "PID-DAI",
  bondIconSvg: "null",
  bondContractABI: BondOhmDaiContract,
  reserveContract: ReserveOhmDaiContract,
